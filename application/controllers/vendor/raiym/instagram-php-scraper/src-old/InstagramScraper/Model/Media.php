    ...
    protected function initPropertiesCustom($value, $prop, $arr)
    {
        ...
        switch ($prop) {
            ...
            case 'type':
                ...
                break;
            case 'created_time':
                $this->createdTime = (int)$value['taken_at_timestamp'];
                break;
            case 'code':
            ...
            case 'edge_sidecar_to_children':
                ...
                break;
            case 'owner':
                $this->owner = Account::create($arr['node'][$prop]);
                break;
            case 'date':
