...
class Instagram
{
     ...
     * @throws InstagramException
     */
    public function getMedias($username, $count = 200, $maxId = '') {
    ...
    public function getAccount($username, $count = 30) {
        // echo $username; exit();

//        $response = Request::get(Endpoints::getAccountJsonLink($username, $count), $this->generateHeaders($this->userSession));
...
//        return Account::create($userArray['graphql']['user']);
    ...
    public function getMediasNew($username, $count) {
        $index = 0;
        $medias = [];
        while ($index < $count) {
            ...
            $maxId = $arr['graphql']['user']['edge_owner_to_timeline_media']['page_info']['end_cursor'];
    ...
    public function getMediasAnalytics($username, $count = 30) {
        // echo $username; exit();
...
//            throw new InstagramNotFoundException('Account with this username does not exist', 404);
        ...
        //echo '<pre>'; print_r($userArray['entry_data']['ProfilePage'][0]['graphql']['user']); echo '</pre>'; exit;
