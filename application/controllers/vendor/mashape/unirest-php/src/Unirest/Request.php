...
class Request
{
    ...
    private static function encodeUrl($url)
    {
        ...
        //echo 'encodeurl start <pre>'; print_r($url_parsed); echo '</pre> encodeurl end <br><bR>';
        ...
        //echo ' encodeUrl response start <pre>'; print_r($result); echo '</pre> <br><bR> encodeUrl response end <br><br>';
