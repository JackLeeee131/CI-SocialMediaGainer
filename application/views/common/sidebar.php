        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li >
                    ...
                    <a href="<?php echo base_url();?>analytics"<?php if($this->uri->segment(1) == 'analytics') { ?>class="active"<?php }?>><i class="fa fa-pie-chart"></i> Analytics</a>
                ...
                <li>
                    ...
                    <a href="<?php echo base_url(); ?>add_funds"<?php if($this->uri->segment(1) == 'add_funds') { ?>class="active"<?php }?>>

                        <i class="fa fa-credit-card-alt"></i> Add Funds
            ...
            <div class="help-icons hidden-xs-down">
			  ...
			  <span class="">
                ...
                <span><a href="<?php echo base_url(); ?>settings/contact"><i class="fa fa-envelope"></i></a>
