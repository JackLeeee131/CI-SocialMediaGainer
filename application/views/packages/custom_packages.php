                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="pills-Followers" role="tabpanel"
                                    ...
                                    <div class="panel-header">
                                        ...
                                        <h4 class="pull-right">
                                            ...
                                            <?php // echo '<pre>'; print_r($range_data); echo '</pre>'; exit; ?>
                                        ...
                                        <div id="validate_min_followers" class="alert alert-danger"
                                             style="display: none;">
                                    ...
                                    <div class="form-group text-left" style="margin-bottom: 10px; display: none"
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-md-4 col-sm-5 pull-left m-p-0" style="text-align: center;">

                                                <select name="dripfeed_id" class="form-control"
                                                        id="dripfeed_id_followers"
                                                        onchange="validate_dripfeed_followers(this.value)">
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (output) {
                                                    ...
                                                    if (output['response'] == 'error') {
                                                        ...
                                                        $('#validate_min_followers').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty']);
                                ...
                                <div class="tab-pane fade" id="pills-Likes" role="tabpanel"
                                    ...
                                    <div class="panel-header">
                                        ...
                                        <div class="clearfix"></div>
                                        <div id="validate_min_likes" class="alert alert-danger" style="display: none;">
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (output) {
                                                    ...
                                                    if (output['response'] == 'error') {
                                                        ...
                                                        $('#validate_min_likes').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty']);
                                ...
                                <div class="tab-pane fade" id="pills-Views" role="tabpanel"
                                    ...
                                    <div class="panel-header">
                                        ...
                                        <div class="clearfix"></div>
                                        <div id="validate_min_views" class="alert alert-danger" style="display: none;">
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (output) {
                                                    ...
                                                    if (output['response'] == 'error') {
                                                        ...
                                                        $('#validate_min_views').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty']);
                                ...
                                <div class="tab-pane fade" id="pills-likes_Views" role="tabpanel"
                                    ...
                                    <div class="panel-header">
                                        ...
                                        <div class="clearfix"></div>
                                        <div id="validate_min_likes_2" class="alert alert-danger"
                                             style="display: none;">
                                    ...
                                    <div class="panel-header">
                                        ...
                                        <div class="clearfix"></div>
                                        <div id="validate_min_views_2" class="alert alert-danger"
                                             style="display: none;">
                                                ...
                                                success: function (output) {
                                                    ...
                                                    if (output['response_likes_2'] == 'error' || output['response_views_2'] == 'error') {
                                                        ...
                                                        if (output['response_views_2'] == 'error') {
                                                            ...
                                                            $('#validate_min_views_2').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty_views_2']);


                                                        }
                                                        if (output['response_likes_2'] == 'error') {

                                                            $('#validate_min_likes_2').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty_likes_2']);
                                                        ...
                                                        $('#validate_min_views_2').hide();

                                                        $('#validate_min_likes_2').hide();
...
<script>
                ...
                $.ajax({
                    ...
                    success: function (output) {
                        ...
                        if (output['response'] == 'error') {
                            ...
                            $('#validate_min_likes_2').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty']);
                ...
                $.ajax({
                    ...
                    success: function (output) {
                        ...
                        if (output['response'] == 'error') {
                            ...
                            $('#validate_min_views_2').css('display', 'block').text("Dripfeed will run " + output['dripfeed_run'] + " Times, So minimum quantity should be " + output['min_qty']);
    ...
    $(document).ready(function () {
        ...
        $('.heading').css('right', 'calc(50% - 219px)');
