...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <main role="main" class="right-section">
            ...
            <div class="col-lg-8 col-sm-10 p-0 offset-lg-2 offset-sm-1">


                <?php $attributes = array('class' => '', 'id' => 'analytics_form');

                echo form_open('analytics/search_account', $attributes); ?>


                <div class="boxstyle">


                    <?php if ($user_detail[0]['total_acc_search'] < 3) { ?>


                        <div class="form-group text-left">

                            <label for="exampleInputEmail1">Search Instagram Account</label>

                            <input name="instagram_name" class="form-control" id="exampleInputEmail1"
                                   placeholder=" Instagram Account" required="" type="text">
                        ...
                        <button type="submit" class="btn btn-success pull-right"> Search <i
                    ...
                    <?php } else { ?>
                        ...
                        <span style="color: #ff0002"> Your Account search limit is reached! </span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-12 col-sm-3">
                                ...
                                <div class="btn-group pull-left" role="group" aria-label="...">
                                    ...
                                    <select class="custom-select mr-sm-8" id="inlineFormCustomSelect"
                                            onchange="get_month_data($('.btn-default.active').attr('id'), this.value)">

                                        <option value="" selected>All Instagyuiyuiyuiram Accounts</option>
                                ...
                                <div class="btn-group pull-right" role="group" aria-label="...">
                                    ...
                                    <button id="all" type="button" class="btn btn-default active"
                                            onclick="get_month_data('all', $('#inlineFormCustomSelect').val())">All
                                        Engagements
                                    </button>
                                    ...
                                    <button id="followers" class="btn btn-default"
                                            onclick="get_month_data('followers', $('#inlineFormCustomSelect').val())">
                                        Followers
                                    </button>
...
<script>
    ...
    $(document).ready(function () {
        $('.heading').css('right', 'calc(50% - 197.5px)');
    });
</script>
